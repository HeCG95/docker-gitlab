...
unicorn['ENV'] = {"RAILS_RELATIVE_URL_ROOT" => "/gitlab"}
...
unicorn['somaxconn'] = 64
unicorn['backlog_socket'] = 64
...
# node_exporter['eome'] e '/var/opt/gitlab/node-exporter'
# node_exporter['log_directory'] = '/var/log/gitlab/node-exporter'
# node_exporter['flags'] = {
#   'collector.textfile.directory' =e "#{node['gitlab']['node-exporter']['home']}/textfile_collector"
# }
